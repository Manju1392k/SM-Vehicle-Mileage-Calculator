...
function Home() {
  ...
  try {
    ...
    var handleSubmit = (event) => {
      ...
      fetch('https://sm-mileage-calculator.vercel.app/save', {
        method: 'POST',
        headers: {
    ...
    <>
      ...
      <div className="w-full grid justify-center">
        <ToastContainer
          position="top-center"
        />
        <h1 className="sm:text-xl lg:text-xl text-3xl bg-white w-max py-4 px-4 mt-3 rounded-md font-bold">SM Vehicle Mileage Calculator</h1>
        ...
        <div className=" bg-white w-[95vw] py-4 px-4 my-3 rounded-md ">
          <form className="flex flex-col items-start" method="post" onSubmit={handleSubmit}>
            ...
            <h1 className='sm:text-lg lg:text-lg font-semibold text-xl'>Fuel Per liter Cost</h1>
            ...
            <h1 className='sm:text-lg lg:text-lg font-semibold text-xl'>Total Refill of Fuel Amout</h1>
            ...
            <h1 className='sm:text-lg lg:text-lg font-semibold text-xl'>Fuel Density</h1>
            ...
            <h1 className='sm:text-lg lg:text-lg font-semibold text-xl'>First Fuel Point Meter Reading</h1>
            ...
            <h1 className='sm:text-lg lg:text-lg font-semibold text-xl'>Second Fuel Point Meter Reading</h1>
